      ...
      {isOpen && (
        ...
        >
          ...
          <div className="relative w-full h-full flex items-center justify-center group">
            ...
            <button
              onClick={onClose}
              className="absolute top-6 right-6 md:top-8 md:right-8 z-50 flex items-center justify-center h-12 w-12 rounded-full border border-white/10 bg-black/50 text-white/70 hover:text-white hover:border-[#41050c]/50 hover:bg-[#41050c]/10 transition-all duration-300 group/close"
                ...
                >
                  <div className="w-full max-w-6xl text-center my-auto">
                    ...
                    <motion.div
                      ...
                      className="mb-12"
                    >
                      <h2 className="text-sm md:text-base font-mono tracking-widest text-[#41050c] uppercase mb-2">
                        Watch More Stories
                      </h2>
                      <h3 className="text-3xl md:text-5xl font-bold text-white tracking-tight">
                        Recommended Projects
                      </h3>
                      <div className="mt-4 w-24 h-1 bg-[#41050c] mx-auto rounded-full" />
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 w-full mb-12">
                      {recommendedVideos.map((vid, idx) => (
                        <motion.div
                          ...
                          className="group/card relative overflow-hidden rounded-2xl border border-white/10 bg-zinc-900/50 aspect-video md:aspect-[4/3] cursor-pointer transition-all duration-500 hover:scale-[1.03] hover:border-[#41050c]/50 hover:shadow-2xl hover:shadow-[#41050c]/10"
                        >
                          ...
                          <div className="absolute inset-0 flex flex-col justify-between p-6 z-20">
                            {/* Small dynamic badge */}
                            <span className="self-start px-2.5 py-1 rounded bg-[#41050c]/20 border border-[#41050c]/30 backdrop-blur-md text-[10px] font-mono uppercase tracking-wider text-[#f6f5f5] opacity-0 group-hover/card:opacity-100 transition-opacity duration-300">
                              Up Next
                            </span>
