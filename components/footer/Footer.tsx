      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-4">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto shrink-0 mt-4 md:mt-0">
          <input
            ...
            className="bg-[#404040] border border-transparent focus:bg-[#404040] focus:border-[#f6f5f5]/20 rounded-full px-6 py-4 !text-[#f6f5f5] text-lg placeholder:text-[#f6f5f5] outline-none w-full md:w-[340px] transition-all"
          />
